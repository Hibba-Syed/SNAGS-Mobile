...
class ActiveSnagsContainer extends StatelessWidget {
  ActiveSnagsContainer({super.key});
          ...
          Row(
            ...
            children: [
              ...
              SizedBox(
                ...
                height: 50,
                child: LineChart(
                  _highRiskSnagsChartData(context),
                ),
              ),
            ],
          ),
  ...
  LineChartData _highRiskSnagsChartData(BuildContext context) {
  ...
  String getTotalActiveSnags(BuildContext context) {
    if (context.read<DashboardCubit>().getActiveSnagsStatistics().isNotEmpty) {
      return context
          .read<DashboardCubit>()
          .getActiveSnagsStatistics()
