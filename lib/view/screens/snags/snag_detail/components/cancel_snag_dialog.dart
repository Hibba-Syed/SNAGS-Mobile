...
class CancelSnagDialog extends StatefulWidget {
  const CancelSnagDialog({super.key});

  @override
  State<CancelSnagDialog> createState() => _CancelSnagDialogState();
}

class _CancelSnagDialogState extends State<CancelSnagDialog> {
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Are you sure you want to mark this snag as cancelled?',
                  ...
                  child: CustomButton(
                    ...
                    onPressed: () {
                      if (_formKey.currentState?.validate() ?? false) {
                        Navigator.pop(context);
                        context.read<SnagDetailCubit>().cancelSnag(
                              context,
